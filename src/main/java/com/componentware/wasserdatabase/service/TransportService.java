...
public class TransportService {
    ...
    public void auftragsberarbeiten(Auftrag auftrag) {
        ...
        Optional<Auftrag> letzterTransportAuftrag = auftragRepository.findTopByTypeOrderByDateDesc(AuftragType.TRANSPORT.name());
        ...
        auftragToUpdate.setType(AuftragType.TRANSPORT.name());
        auftragToUpdate.setStatus(AuftragStatus.FERTIG.name());
